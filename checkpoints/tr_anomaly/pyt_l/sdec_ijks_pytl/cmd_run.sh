...
#!/usr/bin/bash 
#docker run -v /raid/home/nilab/chiara/datasets/input_model/:/app/data/input_model/ -v /raid/home/nilab/chiara/local/:/app/src/local/  --rm -it --gpus device=6  --shm-size=800m verifyber:gpu
...
experiment_path="${repo_verifyber_path}/checkpoints/tr_anomaly/pyt_l/sdec_ijks_pytl/"
...
#Test
best_model_path="${repo_verifyber_path}/runs/sdec_nodropout_loss_nll-tracto-anomaly-ijks-pyt-l_0/models/best_model_ep-60_score-0.879844.pth"
