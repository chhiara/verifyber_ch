...
#!/usr/bin/bash 
#docker run -v /raid/home/nilab/chiara/datasets/input_model/:/app/data/input_model/ -v /raid/home/nilab/chiara/local/:/app/src/local/  --rm -it --gpus device=3  --shm-size=256m verifyber:gpu
...
experiment_path="${repo_verifyber_path}/checkpoints/tr_anomaly/multibundle/af_l-pyt_l-fat_l-ifof_l-ilf_l/sdec_tr_anomaly_afl_pytl_fatl_ifofl_ilfl"
...
#python main.py TR-ANOMALY-MULTI-BUNDLE -opt test --exp ${experiment_path} --config ${config_allTum}\
