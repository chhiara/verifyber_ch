...
#Test
best_model_path="${repo_verifyber_path}/runs/sdec_nodropout_loss_nll-tracto-anomaly-afl_pytl_fatl_ifofl_ilfl_0/models/best_model_ep-180_score-0.818465.pth"
