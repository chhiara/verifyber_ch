...
class TractAnomalyMultiBundleDataset(gDataset):
    def __init__(self,
                 sub_file,
                 root_dir,
                 labels_name,
                 ...
                 #bundle_name="" #the bundle name is not given as input parameter of the class, 
                                # since it can vary according to each subject. 
                                # It is given in the text file specifying the subjects
                 ): 
        """
        Args:
        ...
        if with_gt:
            self.labels = []
            for sub in subjects:
                sb_tr, sub_br, bundle_name=sub.split("__")
    ...
    def getitem(self, idx):
        ...
        sb_tr, sub_br, bundle_name=sub.split("__")
        pattern_data_fn=os.path.join(self.root_dir, sb_tr, sb_tr + '*' + sub_br + '*' +  self.data_name + '*'+ bundle_name + '*' + self.data_ext)
